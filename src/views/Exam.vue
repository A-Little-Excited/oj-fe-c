  ...
  <div class="exam-page flex-col">
    <div class="exam-selected-section flex-col">
      <div class="exam-option-group flex-row justify-between">
        ...
        <!-- 上述代码作用为: 当 selectedOption 与 option.value 相等时就为当前的 option 增加指定样式 -->
        <!-- 其中通过点击事件 selectOption 来修改 selectedOption 的值 -->
      ...
      <div class="center-box">
        ...
        <div class="exam-page-pagination flex-row">
          <el-pagination background layout="total, sizes, prev, pager, next, jumper" :total="totalData"
